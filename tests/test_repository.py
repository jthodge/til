...
def test_git_repository_initialization(temp_git_repo):
...
def test_git_repository_initialization_invalid_path(temp_dir):
...
def test_get_current_branch_detached_head(temp_git_repo):
    """Test getting branch name when in detached HEAD state."""
    repo_path = temp_git_repo.working_dir
    
    # Checkout a commit (detached HEAD)
    temp_git_repo.head.reference = temp_git_repo.head.commit
...
def test_get_file_history(temp_git_repo):
...
def test_get_file_history_with_ref(temp_git_repo):
...
def test_get_file_history_invalid_ref(temp_git_repo):
...
def test_get_file_history_multiple_commits(temp_git_repo, temp_dir):
