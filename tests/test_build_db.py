...
class TestGetCreatedChangedTimes:
    ...
    def test_get_created_changed_times_invalid_ref(self, temp_git_repo: Repo):
        ...
        times = get_created_changed_times(
            Path(temp_git_repo.working_dir), 
            ref="nonexistent"
        )
        assert times == {}
...
class TestBuildDatabase:
    ...
    def test_build_database_from_scratch(self, temp_git_repo: Repo, temp_dir: Path, mock_github_api):
        """Test building database from scratch."""
        config = TILConfig(
            root_path=Path(temp_git_repo.working_dir),
    ...
    def test_build_database_update_existing(self, temp_git_repo: Repo, temp_dir: Path, mock_github_api):
    ...
    def test_build_database_handles_missing_git_history(self, temp_dir: Path, mock_github_api):
