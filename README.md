...
* [Default Error Behavior](https://github.com/jthodge/til/blob/main/content/bash/default-error-behavior.md) - 2025-05-18
* [Use the `DEBUG` Trap to Step Through a Script](https://github.com/jthodge/til/blob/main/content/bash/use-the-debug-trap-to-step-through-a-script.md) - 2025-05-18
* [Always Enclose Variable Names in Double Quotes](https://github.com/jthodge/til/blob/main/content/bash/always-enclose-variable-names-in-double-quotes.md) - 2025-05-18
* [Shell Script Template](https://github.com/jthodge/til/blob/main/content/bash/shell-script-template.md) - 2025-05-18
...
* [`=` Serves as Padding in Base64 Encoded Strings](https://github.com/jthodge/til/blob/main/content/character-encoding/equal-serves-as-padding-in-base64-encoded-strings.md) - 2025-05-18
...
* [Use Logpoints to Log Messages to the Console](https://github.com/jthodge/til/blob/main/content/chrome/use-logpoints-to-log-messages-to-the-console.md) - 2025-05-18
* [Use DevTools to Take Screenshots](https://github.com/jthodge/til/blob/main/content/chrome/use-devtools-to-take-screenshots.md) - 2025-05-18
...
* [`-`](https://github.com/jthodge/til/blob/main/content/clis-and-terminals/dash.md) - 2025-05-18
* [Use Commonly Available Characters for Progress Indicators](https://github.com/jthodge/til/blob/main/content/clis-and-terminals/use-commonly-available-characters-for-progress-indicators.md) - 2025-05-18
...
* [Implement GraphQL Servers in Cloudflare Workers](https://github.com/jthodge/til/blob/main/content/cloudflare/implement-graphql-servers-in-cloudflare-workers.md) - 2025-05-18
...
* [Blurry Image Placeholders](https://github.com/jthodge/til/blob/main/content/css/blurry-image-placeholders.md) - 2025-05-18
* [`grid-area`](https://github.com/jthodge/til/blob/main/content/css/grid-areas.md) - 2025-05-18
* [Upside Down Table Trick](https://github.com/jthodge/til/blob/main/content/css/upside-down-table-trick.md) - 2025-05-18

## curl

* [Useful HTTP Flags](https://github.com/jthodge/til/blob/main/curl/useful-http-flags.md) - 2021-06-28
* [Useful HTTP Flags](https://github.com/jthodge/til/blob/main/content/curl/useful-http-flags.md) - 2025-05-18
...
* [`{% querystring %}` Template Tag](https://github.com/jthodge/til/blob/main/content/django/querystring-template-tag.md) - 2025-05-18
* [Django Drops the SQL `DEFAULT` Constraint When Creating New Columns](https://github.com/jthodge/til/blob/main/content/django/django-drops-the-sql-default-constraint-when-creating-new-columns.md) - 2025-05-18
...
* [Enable Long-Lived Container Logs](https://github.com/jthodge/til/blob/main/content/docker/enable-long-lived-container-logs.md) - 2025-05-18
...
* [Remove All Whitespace from Beginning of All Lines](https://github.com/jthodge/til/blob/main/content/emacs/remove-all-whitespace-from-beginning-of-all-lines.md) - 2025-05-18
* [Update Feature Branch to Latest `main`](https://github.com/jthodge/til/blob/main/content/emacs/update-feature-branch-to-latest-main.md) - 2025-05-18
* [Insert Detailed Timestamps](https://github.com/jthodge/til/blob/main/content/emacs/insert-detailed-timestamps.md) - 2025-05-18
* [Remove All Newlines from a Selected Region](https://github.com/jthodge/til/blob/main/content/emacs/remove-all-newlines-from-a-selected-region.md) - 2025-05-18
...
* [Use Exclamation Marks in Commit Messages](https://github.com/jthodge/til/blob/main/content/git/use-exclamation-marks-in-commit-messages.md) - 2025-05-18
* [Use Multiple `git commit` Message Flags to Create Multiline Commits](https://github.com/jthodge/til/blob/main/content/git/use-multiple-git-commit-message-flags-to-create-multiline-commits.md) - 2025-05-18
* [Get Earliest Commit Over Time Range](https://github.com/jthodge/til/blob/main/content/git/get-earliest-commit-over-time-range.md) - 2025-05-18
* [The Differences Between `.git/info/exclude` and `.gitignore`](https://github.com/jthodge/til/blob/main/content/git/the-differences-between-git-info-exclude-and-gitignore.md) - 2025-05-18
* [Git Only Stores Timestamps and Author Information on Commits](https://github.com/jthodge/til/blob/main/content/git/git-only-stores-timestamp-and-author-information-on-commits.md) - 2025-05-18
* [Move Individual Commits Between Branches with `cherry-pick`](https://github.com/jthodge/til/blob/main/content/git/move-individual-commits-between-branches-with-cherry-pick.md) - 2025-05-18
* [Set Default for Initial Branch Name](https://github.com/jthodge/til/blob/main/content/git/set-default-for-initial-branch-name.md) - 2025-05-18
* [Move a Range of Commits Between Branches](https://github.com/jthodge/til/blob/main/content/git/move-a-range-of-commits-between-branches.md) - 2025-05-18
* [Push an Empty Commit](https://github.com/jthodge/til/blob/main/content/git/push-an-empty-commit.md) - 2025-05-18
...
* [Use the Fuzzy File Finder to Navigate Repos](https://github.com/jthodge/til/blob/main/content/github/use-the-fuzzy-file-finder-to-navigate-repos.md) - 2025-05-18
* [Use Relative Paths to Link to Wiki Pages from README.md](https://github.com/jthodge/til/blob/main/content/github/use-relative-paths-to-link-to-wiki-pages-from-README.md) - 2025-05-18
* [Create New Gists and Repos with `.new` URLs](https://github.com/jthodge/til/blob/main/content/github/create-new-gists-and-repos-with-new-urls.md) - 2025-05-18
...
* [Create Multiline Strings Using Backticks](https://github.com/jthodge/til/blob/main/content/go/create-multiline-strings-using-backticks.md) - 2025-05-18
* [Concatenate Strings Efficiently with `bytes.Buffer` and `strings.Builder`](https://github.com/jthodge/til/blob/main/content/go/concatenate-strings-efficiently-with-bytesbuffer-and-stringsbuilder.md) - 2025-05-18

## graphical-control-elements

* [Throbber](https://github.com/jthodge/til/blob/main/graphical-control-elements/throbber.md) - 2021-06-28
* [Throbber](https://github.com/jthodge/til/blob/main/content/graphical-control-elements/throbber.md) - 2025-05-18
...
* [String Concatenation Operators](https://github.com/jthodge/til/blob/main/content/haskell/string-concatenation-operators.md) - 2025-05-18
...
* [Trigger Opt-in File Downloads with the `Content-Disposition` Response Header](https://github.com/jthodge/til/blob/main/content/http/trigger-opt-in-file-downloads-with-the-content-disposition-response-header.md) - 2025-05-18
* [CORS Preflight Requests Communicate Which Methods and Headers a Server Should Allow](https://github.com/jthodge/til/blob/main/content/http/cors-preflight-requests-communicate-which-methods-and-headers-a-server-should-allow.md) - 2025-05-18
...
* [Pump Large (> 2^53) Numbers Through Your Data Pipeline to Check for Leaks](https://github.com/jthodge/til/blob/main/content/javascript/pump-large-numbers-through-your-data-pipeline-to-check-for-leaks.md) - 2025-05-18
* [JavaScript `RegExp` Objects are Stateful](https://github.com/jthodge/til/blob/main/content/javascript/javascript-regexp-objects-are-stateful.md) - 2025-05-18
* [Inconsistencies in `Date`](https://github.com/jthodge/til/blob/main/content/javascript/inconsistencies-in-date.md) - 2025-05-18
* [Canceling Asynchronous Threads Can Be Tricky](https://github.com/jthodge/til/blob/main/content/javascript/canceling-asynchronous-threads-can-be-tricky.md) - 2025-05-18
* [Dates as Keys are not Equal](https://github.com/jthodge/til/blob/main/content/javascript/dates-as-keys-are-not-equal.md) - 2025-05-18
* [`Object.is` is Different From `===` and `!==`](https://github.com/jthodge/til/blob/main/content/javascript/object-dot-is-is-different-from-strict-value-comparison.md) - 2025-05-18
* [`in` Operator Patterns are Rare](https://github.com/jthodge/til/blob/main/content/javascript/in-operator-patterns-are-rare.md) - 2025-05-18
* [Use Numeric Separators to Parse Large Numbers by Eye](https://github.com/jthodge/til/blob/main/content/javascript/use-numeric-separators-to-parse-large-numbers-by-eye.md) - 2025-05-18
* [Disable Jest's Auto-generated Coverage Reports](https://github.com/jthodge/til/blob/main/content/javascript/disable-jests-auto-generated-coverage-reports.md) - 2025-05-18
* [Every Readable Stream is Asynchronously Iterable](https://github.com/jthodge/til/blob/main/content/javascript/every-readable-stream-is-asynchronously-iterable.md) - 2025-05-18
* [Lexicographical String Comparison](https://github.com/jthodge/til/blob/main/content/javascript/lexicographical-string-comparison.md) - 2025-05-18

## language-features

* [Avoiding Nil](https://github.com/jthodge/til/blob/main/language-features/avoiding-nil.md) - 2021-07-19
* [Avoiding Nil](https://github.com/jthodge/til/blob/main/content/language-features/avoiding-nil.md) - 2025-05-18
...
* [Instruments](https://github.com/jthodge/til/blob/main/content/macos/instruments.md) - 2025-05-18
* [Reveal `.` Files in Finder](https://github.com/jthodge/til/blob/main/content/macos/reveal-hidden-files-in-finder.md) - 2025-05-18
* [Modifier Keys in Menu Bar](https://github.com/jthodge/til/blob/main/content/macos/modifier-keys-in-menu-bar.md) - 2025-05-18
* [Perform Search Engine Queries from Spotlight](https://github.com/jthodge/til/blob/main/content/macos/perform-search-engine-queries-from-spotlight.md) - 2025-05-18
...
* [`libuv` Implements a Reactor Pattern](https://github.com/jthodge/til/blob/main/content/node/libuv-implements-a-reactor-pattern.md) - 2025-05-18
* [Basic Node Test Runner](https://github.com/jthodge/til/blob/main/content/node/basic-node-test-runner.md) - 2025-05-18
...
* [`uv run` in the Shebang Line](https://github.com/jthodge/til/blob/main/content/patterns/uv-run-in-the-shebang-line.md) - 2025-05-18
* [Lazy-Iteration Over Multiple Sorted Enumerables, Preserving Order](https://github.com/jthodge/til/blob/main/content/patterns/lazy-iteration-over-multiple-sorted-enumerables-preserving-order.md) - 2025-05-18
...
* [The Difference Between `Ctrl+c` and `Ctrl+\`](https://github.com/jthodge/til/blob/main/content/posix/the-difference-between-control-c-and-control-backslash.md) - 2025-05-18
...
* [Idenfity `NULL` JSON Values](https://github.com/jthodge/til/blob/main/content/postgres/identify-null-json-values.md) - 2025-05-18
* [Export Text Without Headers and Formatting](https://github.com/jthodge/til/blob/main/content/postgres/export-text-without-headers-and-formatting.md) - 2025-05-18
* [`psql` Notes](https://github.com/jthodge/til/blob/main/content/postgres/psql-notes.md) - 2025-05-18
...
* [`uvtrick`: Run Python Code from `venv` in Current Environment](https://github.com/jthodge/til/blob/main/content/python/uvtrick.md) - 2025-05-18
* [JSON Encoding and Decoding I/O Conversions](https://github.com/jthodge/til/blob/main/content/python/json-encoding-decoding-io.md) - 2025-05-18
* [Creating Deep Copies of Collections](https://github.com/jthodge/til/blob/main/content/python/creating-collection-deepcopies.md) - 2025-05-18
* [Python Development Environment Management (macOS)](https://github.com/jthodge/til/blob/main/content/python/dev-env-mgmt.md) - 2025-05-18
* [Eager and Lazy Evaluation](https://github.com/jthodge/til/blob/main/content/python/eager-and-lazy-evaluation.md) - 2025-05-18
...
* [Use Quine Quotes to Delimit Regular Expressions](https://github.com/jthodge/til/blob/main/content/regex/use-quine-quotes-to-delimit-regular-expressions.md) - 2025-05-18
* [Character Classes Are a Sub-language of Regex](https://github.com/jthodge/til/blob/main/content/regex/character-classes-are-a-sublanguage-of-regex.md) - 2025-05-18
...
* [Specify a Gem Version Range](https://github.com/jthodge/til/blob/main/content/ruby/specify-a-gem-version-range.md) - 2025-05-18
* [Skip Installing Ruby Docs](https://github.com/jthodge/til/blob/main/content/ruby/skip-installing-ruby-docs.md) - 2025-05-18
* [Numeric Literal Prefixes](https://github.com/jthodge/til/blob/main/content/ruby/numeric-literal-prefixes.md) - 2025-05-18
* [Run `rbenv rehash` to Use Newly Installed Versions of Ruby or Gems](https://github.com/jthodge/til/blob/main/content/ruby/run-rbenv-rehash-to-use-newly-installed-versions-of-ruby-or-gems.md) - 2025-05-18
* [Reset Bundle Gems](https://github.com/jthodge/til/blob/main/content/ruby/reset-bundle-gems.md) - 2025-05-18
...
* [Suppress File Names When Grepping Across Multiple Files](https://github.com/jthodge/til/blob/main/content/unix/suppress-file-names-when-grepping-across-multiple-files.md) - 2025-05-18
* [Reset Terminal Password Prompt](https://github.com/jthodge/til/blob/main/content/unix/reset-terminal-password-prompt.md) - 2025-05-18
* [`kill` Works on Any Process](https://github.com/jthodge/til/blob/main/content/unix/kill-works-on-any-process.md) - 2025-05-18
* [Look Up DNS with `host`](https://github.com/jthodge/til/blob/main/content/unix/look-up-dns-with-host.md) - 2025-05-18
* [Use `column` to View Pretty CSVs](https://github.com/jthodge/til/blob/main/content/unix/use-column-to-view-pretty-csvs.md) - 2025-05-18
* [Use the `-i` flag to Confirm Before Overwriting an Existing File](https://github.com/jthodge/til/blob/main/content/unix/use-the-i-flag-to-confirm-before-overwriting-an-existing-file.md) - 2025-05-18
* [`wc -l` is Faster than `wc` For Retrieving the Number of Lines in a Large File](https://github.com/jthodge/til/blob/main/content/unix/wc-l-is-faster-than-wc-for-retrieving-the-number-of-lines-in-a-large-file.md) - 2025-05-18
...
* [Disable Jest Test Runner Auto Run](https://github.com/jthodge/til/blob/main/content/vscode/disable-jest-test-runner-auto-run.md) - 2025-05-18
* [Choose Folders to Ignore During Search](https://github.com/jthodge/til/blob/main/content/vscode/choose-folders-to-ignore-during-search.md) - 2025-05-18
* [Navigate Your Cursor Position History](https://github.com/jthodge/til/blob/main/content/vscode/navigate-your-cursor-position-history.md) - 2025-05-18
<!-- index ends -->
