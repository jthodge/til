...
* [Use Logpoints to Log Messages to the Console](https://github.com/jthodge/til/blob/main/content/chrome/use-logpoints-to-log-messages-to-the-console.md) - 2020-05-03
* [Use DevTools to Take Screenshots](https://github.com/jthodge/til/blob/main/content/chrome/use-devtools-to-take-screenshots.md) - 2020-07-05

## clis-and-terminals

* [Use Commonly Available Characters for Progress Indicators](https://github.com/jthodge/til/blob/main/content/clis-and-terminals/use-commonly-available-characters-for-progress-indicators.md) - 2022-01-09
* [`-`](https://github.com/jthodge/til/blob/main/content/clis-and-terminals/dash.md) - 2024-05-11

## cloudflare

* [Implement GraphQL Servers in Cloudflare Workers](https://github.com/jthodge/til/blob/main/content/cloudflare/implement-graphql-servers-in-cloudflare-workers.md) - 2020-07-27

## css

* [Upside Down Table Trick](https://github.com/jthodge/til/blob/main/content/css/upside-down-table-trick.md) - 2024-08-28
...
* [Remove All Newlines from a Selected Region](https://github.com/jthodge/til/blob/main/content/emacs/remove-all-newlines-from-a-selected-region.md) - 2020-10-17
...
* [Use `stage` Instead of `add` for Clarity](https://github.com/jthodge/til/blob/main/content/git/use-stage-instead-of-add-for-clarity.md) - 2025-07-11

## github

* [Use the Fuzzy File Finder to Navigate Repos](https://github.com/jthodge/til/blob/main/content/github/use-the-fuzzy-file-finder-to-navigate-repos.md) - 2020-05-03
* [Use Relative Paths to Link to Wiki Pages from README.md](https://github.com/jthodge/til/blob/main/content/github/use-relative-paths-to-link-to-wiki-pages-from-README.md) - 2020-07-11
* [Create New Gists and Repos with `.new` URLs](https://github.com/jthodge/til/blob/main/content/github/create-new-gists-and-repos-with-new-urls.md) - 2020-07-18
...
* [grep: Suppress Filenames with -h Flag](https://github.com/jthodge/til/blob/main/content/grep/suppress-filenames-with-h-flag.md) - 2025-07-14
...
* [Trigger Opt-in File Downloads with the `Content-Disposition` Response Header](https://github.com/jthodge/til/blob/main/content/http/trigger-opt-in-file-downloads-with-the-content-disposition-response-header.md) - 2020-10-18
...
* [Avoiding Nil](https://github.com/jthodge/til/blob/main/content/language-features/avoiding-nil.md) - 2021-07-19

## macos

* [Perform Search Engine Queries from Spotlight](https://github.com/jthodge/til/blob/main/content/macos/perform-search-engine-queries-from-spotlight.md) - 2020-08-08
...
* [Avoid Boolean Flag Arguments](https://github.com/jthodge/til/blob/main/content/patterns/avoid-boolean-flag-arguments.md) - 2025-06-12

## posix

* [The Difference Between `Ctrl+c` and `Ctrl+\`](https://github.com/jthodge/til/blob/main/content/posix/the-difference-between-control-c-and-control-backslash.md) - 2020-08-26

## postgres

* [Write a Query Result to a File](https://github.com/jthodge/til/blob/main/content/postgres/write-a-query-result-to-a-file.md) - 2020-07-28
* [Export Text Without Headers and Formatting](https://github.com/jthodge/til/blob/main/content/postgres/export-text-without-headers-and-formatting.md) - 2020-07-28
* [Drop a Database Even When Clients are Connected](https://github.com/jthodge/til/blob/main/content/postgres/drop-a-database-even-when-clients-are-connected.md) - 2020-10-17
* [`psql` Notes](https://github.com/jthodge/til/blob/main/content/postgres/psql-notes.md) - 2024-08-17
...
* [UUID v7 Monotonic Per Backend](https://github.com/jthodge/til/blob/main/content/postgres/uuid-v7-monotonic-per-backend.md) - 2025-07-13

## python

* [Creating Deep Copies of Collections](https://github.com/jthodge/til/blob/main/content/python/creating-collection-deepcopies.md) - 2023-11-10
* [Python `dict.update` method returns `None`](https://github.com/jthodge/til/blob/main/content/python/dict-update-return-values.md) - 2024-02-23
* [JSON Encoding and Decoding I/O Conversions](https://github.com/jthodge/til/blob/main/content/python/json-encoding-decoding-io.md) - 2024-02-23
* [Python Development Environment Management (macOS)](https://github.com/jthodge/til/blob/main/content/python/dev-env-mgmt.md) - 2024-08-11
...
* [Dump pickle files to readable text](https://github.com/jthodge/til/blob/main/content/python/dump-pickle-files-to-readable-text.md) - 2025-07-12
* [Template Strings for Safe Processing](https://github.com/jthodge/til/blob/main/content/python/template-strings-for-safe-processing.md) - 2025-07-13
...
* [Suppress File Names When Grepping Across Multiple Files](https://github.com/jthodge/til/blob/main/content/unix/suppress-file-names-when-grepping-across-multiple-files.md) - 2020-08-05
* [`wc -l` is Faster than `wc` For Retrieving the Number of Lines in a Large File](https://github.com/jthodge/til/blob/main/content/unix/wc-l-is-faster-than-wc-for-retrieving-the-number-of-lines-in-a-large-file.md) - 2020-08-06
* [Reset Terminal Password Prompt](https://github.com/jthodge/til/blob/main/content/unix/reset-terminal-password-prompt.md) - 2020-08-13
